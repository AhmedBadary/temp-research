...
<button>Gradient-Based Optimization</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Maximum Margin Classifiers</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Hard-Margin SVMs
<button>Hard-Margin SVMs</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Soft-Margin SVM
<button>Soft-Margin SVM</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Loss Functions
<button>Loss Functions</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
1. __Define:__{: style="color: red"}  
...
# Information Theory
<button>Information Theory</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Recommendation Systems</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Ensemble Learning
<button>Ensemble Learning</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# K-NN
<button>K-NN</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
{: hidden=""}
...
# PCA
<button>PCA</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# The Centroid Method
<button>The Centroid Method</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# K-Means
<button>K-Means</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Naive Bayes
<button>Naive Bayes</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
1. __Define:__{: style="color: red"}  
...
# CNNs
<button>CNNs</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Theory
<button>Theory</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
{: hidden=""}
...
# RNNs
<button>RNNs</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Optimization
<button>Optimization</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# ML Theory
<button>ML Theory</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Statistical Learning Theory</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Bias-Variance Decomposition Theory</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Activation Functions</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Kernels
<button>Kernels</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Math
<button>Math</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# (Statistics) - MLE
<button>(Statistics) - MLE</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
1. __Clearly Define MLE and derive the final formula:__{: style="color: red"}  
    ...
    1. __How does the form of the model (model family) affect the MLE Estimate?__{: style="color: blue"}  
        The form of the model (e.g. Gaussian Model) determines the resulting loss function (e.g. MSE).  
...
<button>Text-Classification \| Classical</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# NLP
<button>NLP</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Language Modeling
<button>Language Modeling</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Regularization
<button>Regularization</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# Misc.
<button>Misc.</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
1. __Describe ways to overcome scaling (scalability) issues:__{: style="color: red"}  
    ...
    * __Topic Modeling vs Document Classification:__{: style="color: blue"}  
        * __Text Classification__ is a form of supervised learning, hence the set of possible classes are known/defined in advance, and won't change.  
        * __Topic Modeling__ is a form of unsupervised learning (akin to clustering), so the set of possible topics are unknown apriori. They're defined as part of generating the topic models.  <br>
...
<button>FeedForward Neural Network</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Multilayer Perceptron</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Deep Feedforward Neural Networks</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
# AutoEncoders
<button>AutoEncoders</button>{: .showText value="show" onclick="showText_withParent_PopHide(event);"}
...
<button>Show Questions on "Extra"</button>{: .showText value="show"
onclick="showText_withParent_PopHide(event);"}
